...
public class CustomBottomNavigationView1 extends BottomNavigationView {
    ...
    private Path mPath, mPathStrike;
    private Paint mPaint, mPaintStrike;
    ...
    private void init() {
        ...
        mPaintStrike.setStyle(Paint.Style.STROKE);
        mPaintStrike.setColor(ContextCompat.getColor(getContext(), R.color.gray_a));
        mPaintStrike.setStrokeWidth(1.0f);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mFirstCurveStartPoint.set((mNavigationBarWidth / 2) - (CURVE_CIRCLE_RADIUS * 2) - (CURVE_CIRCLE_RADIUS / 3), CURVE_CIRCLE_RADIUS / 2);
        // the coordinates (x,y) of the end point after curve
        mFirstCurveEndPoint.set(mNavigationBarWidth / 2, 0);
        // same thing for the second curve
        mSecondCurveStartPoint = mFirstCurveEndPoint;
        mSecondCurveEndPoint.set((mNavigationBarWidth / 2) + (CURVE_CIRCLE_RADIUS * 2) + (CURVE_CIRCLE_RADIUS / 3), CURVE_CIRCLE_RADIUS / 2);
        ...
        mPath.reset();
        mPath.moveTo(0,CURVE_CIRCLE_RADIUS / 2);
        ...
        mPath.lineTo(mNavigationBarWidth, CURVE_CIRCLE_RADIUS / 2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(mPath,mPaintStrike);
    }
}
