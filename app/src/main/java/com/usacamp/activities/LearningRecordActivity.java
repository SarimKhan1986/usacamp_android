...
public class LearningRecordActivity extends BaseActivity {
    private ListView mlistLearningRecord;
    private ArrayList<LearningRecordItem> marrLearningRecord;
    int type = 0 ;//일반학습    1 : 음성학습
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type == 0) {
            ((TextView)findViewById(R.id.historytitle)).setText("学习记录");
        ...
        {
            ((TextView)findViewById(R.id.historytitle)).setText("跟读记录");
        ...
        mlistLearningRecord = findViewById(R.id.listview_learningrecord);
        ...
        mlistLearningRecord.setAdapter(adapterlearningrecord);
        //Zhuge
        //////ZhugeSDK.getInstance().track(this, Constants.Zhuge_Event_Enter_Profile_MyStudying_Record);
    }
    ...
    public class RecordDateComparator implements Comparator<LearningRecordItem>
    {
        @Override
        public int compare(LearningRecordItem o1, LearningRecordItem o2) {
            SimpleDateFormat o1formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
